...
<div class="block block_left events" style="width: 1200px; float:left;">
	...
	<div class="block_content">
            ...
            <asp:GridView ID="sanLuongTo" runat="server" AutoGenerateColumns="False" 
                            BackColor="White" BorderColor="#CC9966" BorderWidth="0px" CellPadding="4" 
                ...
                onrowdatabound="sanLuongTo_RowDataBound" style="margin-right: 0px">
                            <Columns>
                                <asp:TemplateField HeaderText="TENTO">
                                    ...
                                    <ItemStyle Font-Names="Times New Roman" Font-Size="Medium" Width="117px" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="KT_DHN">
                                    ...
                                    <FooterStyle Font-Names="Times New Roman" Font-Size="Medium" 
                                        HorizontalAlign="Right" VerticalAlign="Middle" Font-Bold="true" />
                                ...
                                <asp:TemplateField HeaderText="KT_SANLUONG">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="ktSanLuong" runat="server" Text='<%# Bind("KT_SANLUONG","{0:0,0}") %>'></asp:Label>
                                    </ItemTemplate>
                                    <FooterStyle Font-Names="Times New Roman" Font-Size="Medium" 
                                        HorizontalAlign="Right" VerticalAlign="Middle" Font-Bold="true" />
                                    <ItemStyle Font-Names="Times New Roman" Font-Size="Medium" 
                                ...
                                <asp:TemplateField HeaderText="KN_SANLUONG">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="knSanLuong" runat="server" Text='<%# Bind("KN_SANLUONG","{0:0,0}") %>'></asp:Label>
                                    </ItemTemplate>
                                    <FooterStyle Font-Names="Times New Roman" Font-Size="Medium" 
                                        HorizontalAlign="Right" VerticalAlign="Middle" Font-Bold="true" />
                                    <ItemStyle Font-Names="Times New Roman" Font-Size="Medium" 
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" 
                                            ...
                                            <tr>
                                                <td style="text-align: left">
                                                    &nbsp;<asp:Image ID="dhn_change_sum" runat="server" Height="24px" Width="30px" />
                                                </td>
                                    ...
                                    <ItemTemplate>
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                            <tr>
                                                ...
                                                <td style="text-align: right">
                                                   <asp:Label ID="Label7" runat="server" Text='<%# Bind("TANGIAM_SANLUONG","{0:0,0}") %>'></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <asp:TemplateField HeaderText="NT_SANLUONG">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="Label9" runat="server" Text='<%# Bind("NT_SANLUONG","{0:0,0}") %>'></asp:Label>
                                    </ItemTemplate>
                                     <FooterStyle Font-Names="Times New Roman" Font-Size="Medium" 
                                        HorizontalAlign="Right" VerticalAlign="Middle" Font-Bold="true" />
                                    <ItemStyle Font-Names="Times New Roman" Font-Size="Medium" 
                                ...
                                <asp:TemplateField HeaderText="NT_TANGIAM_DHN">
                                    ...
                                    <FooterTemplate>
                                        <table border="0" cellpadding="0" cellspacing="0" 
                                            ...
                                            <tr>
                                                <td style="text-align: left">
                                                    &nbsp;<asp:Image ID="nt_dhn_change_sum" runat="server" Height="24px" Width="30px" />
                                                </td>
                                                <td style="text-align: right">
                                    ...
                                    <ItemTemplate>
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                            <tr>
                                                ...
                                                <td style="text-align: right">
                                                    <asp:Label ID="Label10" runat="server" Text='<%# Bind("NT_TANGIAM_DHN","{0:0,0}") %>'></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <asp:TemplateField HeaderText="NT_TANGIAM_SANLUONG">
                                    ...
                                    <FooterTemplate>
                                        <table border="0" cellpadding="0" cellspacing="0" 
                                            ...
                                            <tr>
                                                <td style="text-align: left">
                                                    &nbsp;<asp:Image ID="nt_sl_change_sum" runat="server" Height="24px" Width="30px" />
                                                </td>
                                                <td style="text-align: right">
