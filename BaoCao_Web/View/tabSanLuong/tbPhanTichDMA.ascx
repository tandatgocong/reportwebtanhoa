<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="tbPhanTichDMA.ascx.cs" Inherits="BaoCao_Web.View.tabSanLuong.tbPhanTichDMA" %>
...
<div class="block block_left events" style="width: 1200px; float:left;">
	...
	<div class="block_content">
            ...
            <table cellpadding="0" cellspacing="0" style="width:100%; font-family:Times New Roman; font-size:15px;" class="table_list" >
              <tbody>
                  <tr class="head" >
                    <td class="style6" rowspan="2"><asp:Label ID="lbTieuDe" runat="server" Text="MÃ ĐMA"></asp:Label> 
                        </td>
