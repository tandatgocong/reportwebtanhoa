<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="tabSLTheoDoiTuong.ascx.cs" Inherits="BaoCao_Web.View.tabSanLuong.tabSLTheoDoiTuong" %>
            ...
            <tr>
                ...
                <td class="style2"> 
                    <asp:DropDownList ID="bcTheo" runat="server" 
                        ...
                        <asp:ListItem Value="3">Giá Biểu</asp:ListItem>
                        <asp:ListItem Value="4">Cở ĐHN</asp:ListItem>
    ...
    BorderWidth="1px" CellPadding="4" 
                ...
                <Columns>
                    <asp:TemplateField HeaderText="TENTO">
                        ...
                        <ItemTemplate> 
                           <b> <a  href='<%# Eval("TENTO","tabSanLuong/FillData.aspx?value={0}") %>' ><asp:Label ID="Label1" runat="server" Text='<%# Bind("TENTO") %>'></asp:Label></a></b>                             
                        </ItemTemplate>
