...
namespace QuanLyKhachHang.View
{
    public partial class QuanLyBaoBe : System.Web.UI.Page
    {
        ...
        public void pagLoad()
        {
            ...
            string sql = " SELECT v.*,CASE WHEN v.LoaiThucHien  = 1 THEN N'Hoàn Thiện' ELSE N'' END  AS TenLoai, (CAST(DATEDIFF(HH,TuGio,DenGio) AS VARCHAR)) AS GIO,   CAST(DATEDIFF(mi,TuGio,DenGio)/60 AS VARCHAR) as PHUT, ";
