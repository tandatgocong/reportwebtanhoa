                    ...
                    <tr>
                        ...
                        <td class="style8">
                            <asp:DropDownList ID="cpLoaiGiayPhep" runat="server" Height="19px" 
                                ...
                                <asp:ListItem Value="NP">Nghỉ Phép</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                        <td class="style10">
                        ...
                        &nbsp;<asp:Button ID="Button1" runat="server" CssClass="button" 
                                ...
                                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="TENLOAI" HeaderText="XIN PHÉP" >
                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="120px" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="TNGAY" HeaderText="TỪ NGÀY" >
                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="90px" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="DNGAY" HeaderText="ĐẾN NGÀY" >
                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="90px" />
                                        </asp:BoundField>
